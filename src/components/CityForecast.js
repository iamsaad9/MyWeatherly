...
<div  className="forecast-item">
        ...
        >
          ...
          >
            <button
              ...
              onClick={() => {setcityId(city.id); setVisible(!visible)}}
            >
    ...
    >
      <CModalHeader style={{backgroundColor:'var(--elementBg',color:'white',borderRadius:'5px 5px 0px 0px'}}>
        <CModalTitle  id="LiveDemoExampleLabel">Warning</CModalTitle>
      </CModalHeader>
      <CModalBody style={{backgroundColor:'var(--elementBg',color:'white'}}>
        <p>Are you sure you want to delete this Forcase item?</p>
      </CModalBody>
      <CModalFooter style={{backgroundColor:'var(--elementBg',color:'white',borderRadius:'0px 0px 5px 5px'}}>
        <CButton style={{backgroundColor:'var(--themeColor',border:'none',color:'black',fontWeight:'500'}} onClick={() => setVisible(false)}>
          Cancel
        </CButton>
        <CButton style={{backgroundColor:'#800000',color:'white',fontWeight:'500'}} onClick={() => {removeCity(cityId); setVisible(false)}}>Delete</CButton>
      </CModalFooter>
    </CModal>
